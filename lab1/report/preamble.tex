...
% Зачем: Поддержка LuaLaTeX
\usepackage{iftex}

\ifluatex
  % Настройка шрифтов для Lua-/XeLaTeX
  ...
  % Зачем: В качетсве моноширинного шрифта (для листингов кода и т.п.)
  % Почему: Требование кафедры ПИКС
  \babelfont{tt}{Courier New}
  \babelfont{sf}{Arial}
\else
  % Настройка шрифтов для pdfLaTeX
  ...
  \renewcommand{\ttdefault}{fcr} % Courier New
  \renewcommand{\sfdefault}{far} % Arial
\fi

% Зачем: Учет особенностей различных языков.

\usepackage[activate={true,nocompatibility},final,babel,tracking=true,protrusion=true,expansion=true,factor=1100]{microtype}

% Зачем: Добавляет поддержу дополнительных размеров текста 8pt, 9pt, 10pt, 11pt, 12pt, 14pt, 17pt, and 20pt.
% Почему: Пункт 2.1.1 Требований по оформлению пояснительной записки.
% MikalaiR: extreport уже ключает это все?
% \usepackage{extsizes}
...
\fancypagestyle{plain}{ 
    \fancyhf{}
    \rfoot{\thepage}}
% \setlength{\footskip}{6mm} % ----- @todo: what is it?
...
\renewcommand\section{%
  \@startsection {section}{1}%
    ...
    % {\raggedright\hyphenpenalty=10000\normalfont\large\bfseries\MakeUppercase}}	% @Mikalair
\makeatother
...
\renewcommand\subsection{%
  \@startsection{subsection}{2}%
    ...
    {-1em \@plus -1ex \@minus -.2ex}%
    {1em \@plus .2ex}%
    {\FloatBarrier\raggedright\hyphenpenalty=10000\normalfont\normalsize\bfseries}}
\makeatother
...
\renewcommand\subsubsection{
  \@startsection{subsubsection}{3}%
    {\fivecharsapprox}% {\fivecharsapprox\bfseries}%
    {-1em \@plus -1ex \@minus -.2ex}%
    {\z@}%
...
\newcommand\sectioncentered{%
  \clearpage\@startsection {section}{1}%
    ...
    {-1em \@plus -1ex \@minus -.2ex}%
    {1em \@plus .2ex}%
    {\FloatBarrier\centering\hyphenpenalty=10000\normalfont\bfseries\MakeUppercase}%
    }
\makeatother
...
\captionsetup[figure]{labelformat=stbfigure,justification=centering,skip=0.2em}
...
\lstdefinelanguage{FSharp}{morekeywords={abstract,and,as,assert,base,begin,class,default,delegate,do,done,downcast,downto,elif,else,end,exception,extern,false,finally,for,fun,function,global,if,in,inherit,inline,interface,internal,lazy,let,let!,match,member,module,mutable,namespace,new,not,null,of,open,or,override,private,public,rec,return,return!,select,static,struct,then,to,true,try,type,upcast,use,use!,val,void,when,while,with,yield,yield!,asr,land,lor,lsl,lsr,lxor,mod,sig,atomic,break,checked,component,const,constraint,constructor,continue,eager,event,external,fixed,functor,include,method,mixin,object,parallel,process,protected,pure,sealed,tailcall,trait,virtual,volatile},
...
% \AtBeginDocument{\numberwithin{lstlisting}{section}}% it looks like it is broken in latest texlive
\AfterEndPreamble{\numberwithin{lstlisting}{section}}

\usepackage[normalem]{ulem}

\usepackage[final,hidelinks,pdfusetitle]{hyperref}
...
\renewcommand{\section}[2][справочное]{
  \refstepcounter{section}
  \addtocounter{totappendices}{1}
  \vspace{1em}\clearpage\phantomsection\noindent{
    \begin{center}
      \bfseries\MakeUppercase{\appendixname}\ \thesection\linebreak(##1)\linebreak ##2
    \end{center}}
  \addcontentsline{toc}{section}{\appendixname\ \thesection\ (##1)\ ##2}
}
